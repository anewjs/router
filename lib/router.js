...
export var AnewRouter = function AnewRouter(use, _config) {
  ...
  _defineProperty(this, "wrap", function (Component, config, isRoot) {
    ...
    var history = _this.configuration.history;
  ...
  _defineProperty(this, "render", function (_ref10, config) {
    ...
    var _this$configuration2 = _this.configuration,
        ...
        history = _this$configuration2.history,
        extraProps = _objectWithoutPropertiesLoose(_this$configuration2, ["Switch", "Route", "history"]);

    return routes ? React.createElement(Switch, history ? {
      ...
      return React.createElement(Route, {
        ...
        render: function render(props) {
          ...
          return redirectTo ? React.createElement(_this.Redirect, typeof redirectTo === 'function' ? redirectTo(_this) : redirectTo) : Component ? React.createElement(Component, componentProps) : _render(componentProps);
        }
      });
    })) : null;
  });
