...
var _initialiseProps = function _initialiseProps() {
    ...
    this.wrap = function () {
        ...
        var _configuration$config = _extends({}, _this.configuration, config),
            ...
            _configuration$config4 = _configuration$config.isRoot,
            isRoot = _configuration$config4 === undefined ? false : _configuration$config4,
    ...
    this.render = function (_ref6) {
        ...
        var _configuration$config5 = _extends({}, _this.configuration, config),
            _configuration$config6 = _configuration$config5.Switch,
            Switch = _configuration$config6 === undefined ? _reactRouterDom.Switch : _configuration$config6,
            _configuration$config7 = _configuration$config5.Route,
            Route = _configuration$config7 === undefined ? _reactRouterDom.Route : _configuration$config7,
            extraProps = _objectWithoutProperties(_configuration$config5, ['Switch', 'Route']);
