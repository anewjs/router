...
exports.default = createRouteChainMethods;
...
function createRouteChainMethods(context, name, path, route) {
    var compiledPath = (0, _pathToRegexp.compile)(path);
    ...
    return {
        ...
        redirect: function redirect(params) {
            return context.redirect(compiledPath(params));
        }
    };
}