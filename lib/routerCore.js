...
var RouterCore = function () {
    ...
    _createClass(RouterCore, [{
        ...
        value: function wrap(Component) {
            ...
            var route = { routes: this.routes };
            var RouteComponent = _react2.default.createElement(Route, { render: function render(props) {
                    return _react2.default.createElement(Component, _extends({}, props, { route: route }));
                } });
            ...
            if (id) {
                (0, _reactDom.render)(_react2.default.createElement(AnewRouter, null), document.getElementById(id));
            }
        ...
        value: function match(pathname) {
            var _ref4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
                ...
                strict = _ref4$strict === undefined ? true : _ref4$strict;
